...
// CODE HERE
const totalPopulation  = populations.reduce(function(tPop, curr)
{
  return tPop + curr;
})
...
// CODE HERE
let orderTotals = []
 orders.forEach(function(obj, index)
{
   orderTotals[index] = obj.price + (obj.price * obj.tax);
})
